...
import com.github.procyonprojects.marker.element.StringElement;
...
public class MarkerReferenceContributor extends PsiReferenceContributor {
    ...
    private PsiReference[] getReferences(PsiElement element) {
        ...
        if (parseResult != null) {
            ...
            return new PsiReference[]{new MarkerProcessorReference(element, markerElement)};
        }
