...
public class TypeScopeProcessor extends GoScopeProcessor {
    ...
    public TypeScopeProcessor(@NotNull CompletionResultSet result, @NotNull PsiFile originalFile, boolean forTypes, @NotNull GoExpectedTypes expectedTypes, @NotNull CompletionParameters parameters) {
        super();
    ...
    protected boolean accept(@NotNull PsiElement e) {
        if (!(e instanceof GoTypeSpecImpl) && !(e instanceof GoImportSpecImpl)) {
            return false;
        }
